  ...
  useEffect(() => {
    const fetchUpcoming = async () => {
      try {
        ...
        const params = new URLSearchParams({
          ...
          sort_by:
            type === 'movie'
              ...
              : 'first_air_date.asc',
          [`${type === 'movie' ? 'primary_release_date.gte' : 'first_air_date.gte'}`]: tomorrow,
        });
        ...
        console.error('Fetching upcoming failed:', err);
      }
    };
    fetchUpcoming();
  }, [type, page, language]);
        ...
        <div className="flex flex-wrap justify-between items-center gap-4 mb-6">
          <div className="flex flex-col sm:flex-row sm:items-center gap-4">
            <h2 className="text-3xl font-bold text-purple-500">
              Upcoming {type === 'movie' ? 'Movies' : 'Series'}
            </h2>
            ...
            <div className="relative z-10">
              <select
                ...
                className="bg-gray-800 text-white px-4 py-2 rounded text-sm border border-gray-600 cursor-pointer appearance-none focus:outline-none focus:ring-2 focus:ring-purple-500"
              >
      ...
      p === '...' ? (
        ...
        <button
          ...
          className={`px-3 py-1 rounded text-sm ${
            p === page ? 'bg-purple-600 text-white' : 'bg-gray-800 text-gray-300 hover:bg-gray-600'
          }`}
        >
          {p}
        </button>
